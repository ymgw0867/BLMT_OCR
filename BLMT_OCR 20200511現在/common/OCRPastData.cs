...
namespace BLMT_OCR.common
{
    class OCRPastData
    {
        ...
        ///---------------------------------------------------------------------------------
        private DataSet1.過去勤務票ヘッダRow setNewHeadRecRow(DataSet1 tblSt, string[] stCSV)
        {
            DataSet1.過去勤務票ヘッダRow r = tblSt.過去勤務票ヘッダ.New過去勤務票ヘッダRow();
        ...
        ///---------------------------------------------------------------------------------
        private DataSet1.過去勤務票明細Row setNewItemRecRow(DataSet1 tblSt, string headerKey, string[] stCSV, int sShopCode)
        {
            DataSet1.過去勤務票明細Row r = tblSt.過去勤務票明細.New過去勤務票明細Row();
        ...
        ///-----------------------------------------------------------------------------------------------
        public Boolean errCheckMain(DataSet1 dts, string hID)
        {
            Boolean eCheck = true;

            //// 勤務票ヘッダ行のコレクションを取得します
            //DataSet1.過去勤務票ヘッダRow r = dts.過去勤務票ヘッダ.Single(a => a.ID == hID);
        ...
        ///-----------------------------------------------------------------------------------------------
        /// 
        public Boolean errCheckData(DataSet1 dts, DataSet1.過去勤務票ヘッダRow r, clsStaff [] stf)
        {
            //// 確認チェック
        ...
        //private bool chkJiyuHas(DataSet1.過去勤務票明細Row m, string mJiyu)
        //{
        ...
        ///------------------------------------------------------------
        private bool errCheckSNum(DataSet1.過去勤務票ヘッダRow r, clsStaff[] stf)
        {
            bool rtn = false;
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckRestTime(DataSet1.過去勤務票明細Row m, string tittle, int iX)
        {
            // 出退勤時間未記入
            string sTimeW = m.出勤時.Trim() + m.出勤分.Trim();
            string eTimeW = m.退勤時.Trim() + m.退勤分.Trim();
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckYukyuCheck(DataSet1.過去勤務票明細Row m, string tittle, int iX)
        {
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckDailyShopCode(DataSet1.過去勤務票明細Row m, string tittle, int iX, clsStaff[] stf)
        {
            bool rtn = false;
        ...
        ///     DataSet1.過去勤務票ヘッダRow</param>
        /// <param name="mList">
        ///     List<DataSet1.過去勤務票明細Row> </param>
        /// <returns>
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckWorkDaysTotal(DataSet1.過去勤務票ヘッダRow r, List<DataSet1.過去勤務票明細Row> mList)
        {
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckNoWork(DataSet1.過去勤務票ヘッダRow r)
        {
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckYukyuDaysTotal(DataSet1.過去勤務票ヘッダRow r, List<DataSet1.過去勤務票明細Row> mList)
        {
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckKoukyuDaysTotal(DataSet1.過去勤務票ヘッダRow r, List<DataSet1.過去勤務票明細Row> mList)
        {
        ...
        private bool getSameNumber(DataSet1 dts, int sNum)
        {
            ...
            // 指定した社員番号の件数を調べる
            if (dts.過去勤務票ヘッダ.Count(a => a.スタッフコード == sNum) > 1)
            {
                rtn = false;
            }
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckZanTm(DataSet1.過去勤務票明細Row m, string tittle, int iX, Int64 zan)
        {
            //Int64 mZan = 0;
        ...
        ///     時間外・分</returns>
        /// ----------------------------------------------------------------------------------
        public Int64 getZangyoTime(DataSet1.過去勤務票明細Row m, Int64 Tani, Int64 ws, Int64 restTime, out Int64 s10Rest, int taikeiCode)
        {
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckShinya(DataSet1.過去勤務票明細Row m, string tittle, int Tani, int iX)
        {
        //    // 無記入なら終了
        ...
        ///     エラーなし：true, エラーあり：false</returns>
        ///------------------------------------------------------------------------------------
        private bool errCheckShinyaTm(DataSet1.過去勤務票明細Row m, string tittle, int iX, Int64 shinya)
        {
            Int64 mShinya = 0;
