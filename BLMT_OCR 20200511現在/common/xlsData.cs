...
namespace BLMT_OCR.common
{
    public class xlsData
    {
        ...
        public object[,] getShiftCode()
        {
            ...
            //Excel.Workbook oXlsBook = (Excel.Workbook)(oXls.Workbooks.Open(Properties.Settings.Default.xlsBmnShift, Type.Missing, Type.Missing, Type.Missing, Type.Missing,
